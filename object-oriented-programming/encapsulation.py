...
"""
Encapsulation - The practice of binding data and methods into a single class
and restricting direct access to some attributes to protect the internal state
of an object.
"""
...
# Protected attributes - A class member whose name starts with a single
# underscore (_).
class Employee:
...
# Private attributes - Indicates that an attribute is intended to be private
...
# Name mangling - Used to make class attributes less accessible from outside
# the class and to avoid accidental name conflicts, especially in inheritance.
class Code:
    def __init__(self):
