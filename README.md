...
I'm building toward a Generative AI Engineer role at a product company, following a
structured path: Python → Math & DSA foundations → Machine Learning → Deep Learning
& Transformers → LLMs, RAG, and Agents. The full breakdown with checkboxes is in
ROADMAP.md — this README only tracks what's actually built, so it
stays honest as a portfolio piece.
Connect
